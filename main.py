...
#log{background:#000;color:#0f0;height:420px;overflow:auto;padding:10px}
button{padding:14px 30px;margin:10px;background:#06c;color:#fff;border:none;border-radius:8px}
</style>
<h2>一刻相册 - 批量4张</h2>
<button onclick="fetch()">获取列表</button>
<button onclick="download()">开始下载</button>
<div id="log">日志加载中...</div>
<script>
function fetch(){fetch("/fetch")}
